...
$(window).bind('scroll', function()
{
    ...
    {
        $('.navigation').addClass('coloring');
        $('.logonormal').addClass('disappear');
        $('.logoscroll').removeClass('disappear');
    }

    else if ($(window).scrollTop() <= 50 && $(window).width() > 900)
    {
        $('.navigation').removeClass('coloring');
        $('.logoscroll').addClass('disappear');
        $('.logonormal').removeClass('disappear');
    }
});
